	...
	<body class="footerBody">
		<div class="container">
			<main class="footerMain">
				...
				<div class="row">
					<div class="col-md-6">
						<ul class="nav nav-tabs">
							...
							<li role="presentation" class="active"><a href="index.php">Wireframes</a></li>
						</ul>
					</div>
				...
				<h1 class="page-header">User Settings, Desktop</h1>

				<img src="desktop-settings.svg" alt="User Settings, Desktop" class="img-responsive">
